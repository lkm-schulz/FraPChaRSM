...
//libraryDependencies += "com.amazonaws" % "aws-java-sdk-core" % "1.12.262" from ("file://" + currentDirectory + "/docker/picklejars/aws-java-sdk-core-1.12.262.jar")
//libraryDependencies += "com.amazonaws" % "aws-java-sdk-s3" % "1.12.262" from ("file://" + currentDirectory + "/docker/picklejars/aws-java-sdk-s3-1.12.262.jar")
